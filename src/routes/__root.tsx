...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { title: "YiriGo" },
      { name: "description", content: "YiriGo is a premium accommodation booking platform for Burkina Faso." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "YiriGo" },
      { property: "og:description", content: "YiriGo is a premium accommodation booking platform for Burkina Faso." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@YiriGo" },
      { name: "twitter:title", content: "YiriGo" },
      { name: "twitter:description", content: "YiriGo is a premium accommodation booking platform for Burkina Faso." },

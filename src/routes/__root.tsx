...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { title: "YiriGo" },
      { name: "description", content: "YiriGo — Réservez des hébergements vérifiés au Burkina Faso. Paiement mobile money, hôtes certifiés." },
      { name: "author", content: "YiriGo" },
      { property: "og:title", content: "YiriGo" },
      { property: "og:description", content: "YiriGo — Réservez des hébergements vérifiés au Burkina Faso. Paiement mobile money, hôtes certifiés." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@YiriGo" },
      { name: "twitter:title", content: "YiriGo" },
      { name: "twitter:description", content: "YiriGo — Réservez des hébergements vérifiés au Burkina Faso." },
